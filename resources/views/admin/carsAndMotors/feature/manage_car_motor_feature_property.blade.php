                                    ...
                                    @if ($language->status == 1)
                                        ...
                                        @elseif($language->language == 'gr')
                                            <tr>
                                                ...
                                                <th scope="col">Feature-Eigenschaft</th>
                                                ...
                                                @if ($language->status == 1)
                                                    @if ($language->language == 'en')
                                                        <a class="btn btn-primary btn-sm"
                                                           href="{{ route('edit.car.motor.features.property', ['id' => $feature->id]) }}">Edit</a>
                                                    @elseif($language->language == 'gr')
                                                        <a class="btn btn-primary btn-sm"
                                                           href="{{ route('edit.car.motor.features.property', ['id' => $feature->id]) }}">Bearbeiten</a>
                                                    @endif
                                                @endif
                                            @endforeach
                                        </td>
