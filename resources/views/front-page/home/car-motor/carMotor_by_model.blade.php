            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        ...
                        <li><a href="{{route('product.by.category',['id'=>$category_data])}}">{{$category->category_name}}</a></li>
                        {{--                            @dd($category->id)--}}
                        @php $category_data = $category->id @endphp
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="product-sidebar">
                            ...
                            <ul class="list">
                                ...
                                @foreach($brands as $brand)
                                    @foreach(array_unique($p_brands) as $i)
                                        @if($i == $brand->id)
                                            <li>
                                                <form action="{{route('carMotor.by.brand',['id'=>$brand->id])}}" method="get">
                            ...
                            <ul class="list">
                                ...
                                @foreach($models as $model)
                                    <li>
                                        ...
                                        <form action="{{route('carMotor.by.model',['id'=>$model->id])}}" method="get">
                                            <input type="hidden" name="category_id" value="{{$category_data}}">
                                            <input type="hidden" name="brand_id" value="{{$brand->id}}">
                                            <button type="submit" class="data-btn">{{$model->model_name}}</button>
                                        </form>
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        <div class="single-widget">
                                ...
                                @foreach($categories as $category)
                                    <li>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="category_id" value="{{$category->id}}" id="{{$category->id}}" {{request()->category_id==$category->id?'checked':''}} onChange="this.form.submit()">
                                            <form action="" method="GET">
                                                <input class="form-check-input" type="hidden" name="category_id" value="{{$category->id}}" id="{{$category->id}}" {{request()->category_id==$category->id?'checked':''}} onChange="this.form.submit()">
                                                <button for="{{$category->id}}" type="submit" class="data-btn">{{$category->category_name}}</button>
                                            </form>
                                        </div>
                                    </li>
                            ...
                            {{--                                                <div class="form-check">--}}
                            {{--                                                    --}}{{--                                        @php dd(request()->category_id) @endphp--}}
                            {{--                                                    <input class="form-check-input" type="checkbox" name="category_id[]" value="{{$category->id}}" id="{{$category->id}}" {{request()->category_id==$category->id?'checked':''}}">--}}
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                @foreach($subcategories as $subcategory)
                                    <li>
                                        <a href="{{route('carMotor.by.subCategory',['id'=>$subcategory->id])}}">{{$subcategory->sub_category_name}} </a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="single-widget range">
                            ...
                            @foreach($languages as $language)
                                ...
                                @endif
                            @endforeach
                            <form action="{{route('carMotor.by.price')}}" method="GET">
                                @csrf
                                <input type="hidden" name="category_id" value="{{$category_data}}">
                        ...
                        <div class="single-widget condition">
                            ...
                            <ul class="list">
                                ...
                                @foreach(array_unique($edition) as $i)
                                    @if($i!= NULL)
                                        <li> <form action="{{route('carMotor.by.edition',['edition'=>$i])}}" method="get">
                                                <input type="hidden" name="category_id" value="{{$category_data}}">
                                    ...
                                    <li>
                                        ...
                                        <ul class="list">
                                            @foreach(json_decode($feature->features_property) as $data)
                                                ...
                                                <li>
                                                    <form action="{{route('carMotor.by.feature')}}" method="get">
                                                        <input type="hidden" name="category_id" value="{{$category_data}}">
                        ...
                        <div class="single-widget condition">
                            ...
                            @foreach($languages as $language)
                                @if($language->status==1)
                                    @if($language->language=='en')
                                        <h3>Filter by Manufacture year</h3>

                                    @elseif($language->language=='gr')
                                        <h3>Filtern Sie nach Herstellungsjahr</h3>
                                    @endif
                                @endif
                            @endforeach
                            <ul class="list">
                                @php $manufacture = [] @endphp
                                @foreach($products as $product)
                                    @php array_push($manufacture,$product->manufacture_year) @endphp
                                @endforeach
                                @foreach(array_unique($manufacture) as $i)
                                    @if($i!= NULL)
                                        <li> <form action="{{route('carMotor.by.manufacture',['year'=>$i])}}" method="get">
                                                <input type="hidden" name="category_id" value="{{$category_data}}">
                                                <button type="submit" class="data-btn">{{$i}}</button>
                                            </form>
                                        </li>
                        ...
                        <div class="single-widget condition">
                            ...
                            @foreach($languages as $language)
                                @if($language->status==1)
                                    @if($language->language=='en')
                                        <h3>Filter by Kilometer run</h3>

                                    @elseif($language->language=='gr')
                                        <h3>Filtern Sie nach gelaufenen Kilometern</h3>
                                    @endif
                                @endif
                            @endforeach
                            <ul class="list">
                                @php $kilo = [] @endphp
                                @foreach($products as $product)
                                    @php array_push($kilo,$product->kilomertes_run) @endphp
                                @endforeach
                                @foreach(array_unique($kilo) as $i)
                                    @if($i!= NULL)
                                        <li> <form action="{{route('carMotor.by.KiloMeter',['kilo'=>$i])}}" method="get">
                                                <input type="hidden" name="category_id" value="{{$category_data}}">
                                                <button type="submit" class="data-btn">{{$i}} KM</button>
                                            </form>
                                        </li>
                                    @endif
                                @endforeach
                        ...
                        <div class="single-widget condition">
                            ...
                            @foreach($languages as $language)
                                @if($language->status==1)
                                    @if($language->language=='en')
                                        <h3>Filter by Engine Capacity</h3>

                                    @elseif($language->language=='gr')
                                        <h3>Filtern Sie nach Motorkapazität</h3>
                                    @endif
                                @endif
                            @endforeach
                            <ul class="list">
                                @php $engine = [] @endphp
                                @foreach($products as $product)
                                    @php array_push($engine,$product->engine_capacity) @endphp
                                @endforeach
                                @foreach(array_unique($engine) as $i)
                                    @if($i!= NULL)
                                        <li> <form action="{{route('carMotor.by.capacity',['capacity'=>$i])}}" method="get">
                                                <input type="hidden" name="category_id" value="{{$category_data}}">
                                                <button type="submit" class="data-btn">{{$i}}</button>
                                            </form>
                                        </li>
                        ...
                        <div class="single-widget condition">
                            ...
                            @foreach($languages as $language)
                                @if($language->status==1)
                                    @if($language->language=='en')
                                        <h3>Filter by Registration Year</h3>

                                    @elseif($language->language=='gr')
                                        <h3>Filtern Sie nach Registrierungsjahr</h3>
                                    @endif
                                @endif
                            @endforeach
                            <ul class="list">
                                @php $reg = [] @endphp
                                @foreach($products as $product)
                                    @php array_push($reg,$product->registration_year) @endphp
                                @endforeach
                                @foreach(array_unique($reg) as $i)
                                    @if($i!= NULL)
                                        <li> <form action="{{route('carMotor.by.registration',['year'=>$i])}}" method="get">
                                                <input type="hidden" name="category_id" value="{{$category_data}}">
                                                <button type="submit" class="data-btn">{{$i}}</button>
                                            </form>
                                        </li>
                                ...
                                @if($language->status==1)
                                    @if($language->language=='en')
                                        ...
                                        <ul class="list">
                                            ...
                                            <li> <form action="{{route('carMotor.by.transmission',['transmission'=>'automatic'])}}" method="get">
                                                    <input type="hidden" name="category_id" value="{{$category_data}}">
                                                    <button type="submit" class="data-btn">Automatic</button>
                                                </form>
                                            </li>
                                            <li> <form action="{{route('carMotor.by.transmission',['transmission'=>'manual'])}}" method="get">
                                                    <input type="hidden" name="category_id" value="{{$category_data}}">
                                                    <button type="submit" class="data-btn">Manual</button>
                                                </form>
                                            </li>
                                            <li> <form action="{{route('carMotor.by.transmission',['transmission'=>'other_transmission'])}}" method="get">
                                                    <input type="hidden" name="category_id" value="{{$category_data}}">
                                                    <button type="submit" class="data-btn">Other Transmission</button>
                                                </form>
                                            </li>
                                        </ul>
                                    @elseif($language->language=='gr')
                                        <h3>Nach Übertragung filtern</h3>
                                        <ul class="list">

                                            <li> <form action="{{route('product.by.authenticity',['authenticity'=>'original'])}}" method="get">
                                                    <input type="hidden" name="category_id" value="{{$category_data}}">
                                                    <button type="submit" class="data-btn">Automatisch</button>
                                                </form>
                                            </li>
                                            <li> <form action="{{route('product.by.authenticity',['authenticity'=>'refurbished'])}}" method="get">
                                                    <input type="hidden" name="category_id" value="{{$category_data}}">
                                                    <button type="submit" class="data-btn">Handbuch</button>
                                                </form>
                                            </li>
                                            <li> <form action="{{route('product.by.authenticity',['authenticity'=>'refurbished'])}}" method="get">
                                                    <input type="hidden" name="category_id" value="{{$category_data}}">
                                                    <button type="submit" class="data-btn">Andere Übertragung</button>
                                                </form>
                                            </li>
                                        </ul>
                                    @endif
                            ...
                            <ul class="list">
                                ...
                                @foreach(array_unique($districts) as $i)
                                    ...
                                    @foreach($product_districts as $d)
                                        @if($i == $d->id)
                                            <li>
                                                <form action="{{route('carMotor.by.district',['district'=>$d->id])}}" method="get">
                    ...
                    <div class="product-grids-head">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                                <div class="row" id="product-section1">
                                    @foreach($products as $product)
                                        <div class="col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="single-product">
                                                <div class="product-image">
                                                    ...
                                                    <div class="button">
                                                        <a href="{{route('carMotor.product.details',['id'=>$product->id])}}" class="btn">Details</a>
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane show active fade" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab">
                                <div class="row" id="product-section2">
                                    @foreach($products as $product)
