        ...
        @foreach($languages as $language)
            @if($language->status==1)
                @if($language->language=='en')
                    ...
                    <div class="brand-section">
                        ...
                        @foreach($subcategories as $subcategory)
                            <a href="{{route('product.by.subCategory',['id'=>$subcategory->id])}}" class="my-2">{{$subcategory->sub_category_name}}</a>
                        @endforeach
                    </div>
                    <div class="brand-section">
                        <h5 class="mt-4 mb-3">Sub Sub Category</h5>
                        @foreach($subsubcategories as $subsubcategory)
                            <a href="{{route('product.by.subSubCategory',['id'=>$subsubcategory->id])}}" class="my-2">{{$subsubcategory->sub_sub_category_name}}</a>
                        @endforeach
                    </div>
                ...
                @elseif($language->language=='gr')
                    ...
                    <div class="brand-section">
                        <h5 class="mt-4 mb-3">Unterunterkategorie</h5>
                        @foreach($subsubcategories as $subsubcategory)
                            ...
                            <ul class="list">
                                ...
                                @foreach($models as $model)
                                    <li>
                                        ...
                                        <form action="{{route('product.by.model',['id'=>$model->id])}}" method="get">
                                            <input type="hidden" name="category_id" value="{{$category_id}}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="pagination left">
                                            <ul class="pagination-list">
                                                ...
                                                <li><a href="javascript:void(0)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
