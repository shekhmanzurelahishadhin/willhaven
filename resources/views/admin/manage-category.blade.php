                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @foreach($languages as $language)
                                                    @if($language->status==1)
                                                        @if($language->language=='en')
                                                            <a class="btn btn-primary btn-sm" href="{{route('edit.category',['category_id'=>$category->id])}}">Edit</a>
                                                        @elseif($language->language=='gr')
                                                            <a class="btn btn-primary btn-sm" href="{{route('edit.category',['category_id'=>$category->id])}}">
                                                                Bearbeiten</a>
                                                        @endif
                                                    @endif
                                                @endforeach
