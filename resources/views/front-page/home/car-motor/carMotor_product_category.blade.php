                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($categories as $category)
                                <a href="{{route('get.carMotor.subCategory',['category_id'=>$category->id])}}">{{$category->category_name}} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
