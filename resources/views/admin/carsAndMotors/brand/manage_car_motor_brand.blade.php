                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach($languages as $language)
                                                @if($language->status==1)
                                                    @if($language->language=='en')
                                                        <a class="btn btn-primary btn-sm" href="{{route('edit.car.motor.brand',['id'=>$brand->id])}}">Edit</a>
                                                    @elseif($language->language=='gr')
                                                        <a class="btn btn-primary btn-sm" href="{{route('edit.car.motor.brand',['id'=>$brand->id])}}">Bearbeiten</a>
                                                    @endif
                                                @endif
                                            @endforeach
                                        </td>
