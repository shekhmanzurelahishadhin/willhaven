        ...
        <div class="row">
            <div class="col-12 mx-auto card p-4 mt-5">
                @foreach($languages as $language)
                    ...
                    @endif
                @endforeach
                <form class="row g-3" method="POST" action="{{route('update.car.motor.category')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12">
                        @foreach($languages as $language)
                            ...
                            @endif
                        @endforeach
                        <input type="text" class="form-control" name="category_name" value="{{$category->category_name}}" id="inputCategory">
                    </div>
