                        ...
                        <div class="form-check">
                            <div class="row mb-4">
                                <div class="col-12 col-md-12" id="feature-section">
                                    @foreach($feature_properties as $properties)

                                            <lable>{{$properties->features_name}}</lable>
                                            <br>
                                            @foreach(json_decode($properties->features_property) as $data)
                                                @if($data!= null)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="{{$data}}" name="features_property[]"  id="{{$data}}">
